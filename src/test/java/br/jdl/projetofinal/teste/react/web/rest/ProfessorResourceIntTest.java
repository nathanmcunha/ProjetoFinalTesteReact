...
import br.jdl.projetofinal.teste.react.domain.Professor;
import br.jdl.projetofinal.teste.react.repository.ProfessorRepository;
...
public class ProfessorResourceIntTest {
    ...
    public void getAllProfessorsWithEagerRelationshipsIsEnabled() throws Exception {
        ProfessorResource professorResource = new ProfessorResource(professorRepositoryMock);
